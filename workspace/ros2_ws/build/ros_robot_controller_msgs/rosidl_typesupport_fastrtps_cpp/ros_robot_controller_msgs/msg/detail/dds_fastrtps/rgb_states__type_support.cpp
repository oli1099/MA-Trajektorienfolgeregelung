...
#include "ros_robot_controller_msgs/msg/detail/rgb_states__rosidl_typesupport_fastrtps_cpp.hpp"
...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_RGBState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_robot_controller_msgs::msg::RGBStates;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros_robot_controller_msgs
max_serialized_size_key_RGBStates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_robot_controller_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_RGBState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const ros_robot_controller_msgs::msg::RGBStates *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_robot_controller_msgs::msg::RGBStates *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RGBStates__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros_robot_controller_msgs::msg::RGBStates *>(
...
static size_t _RGBStates__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RGBStates(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RGBStates__callbacks = {
...
static rosidl_message_type_support_t _RGBStates__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RGBStates__callbacks,
...
{
  return &ros_robot_controller_msgs::msg::typesupport_fastrtps_cpp::_RGBStates__handle;
}
