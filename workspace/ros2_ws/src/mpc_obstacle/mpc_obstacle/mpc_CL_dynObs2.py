...
class MPCClosedLoop(Node):
    ...
    def compute_obstacle_constraints(self,x_current):
        ...
        if carX <= obsXrl :
            ...
            if carX >= obsXrl + obslength + 2*self.Safezone +0.1: #and carX <= obsXrl + obslength + 2*self.Safezone + self.return_distance:
    ...
    def mpc_closedloop(self):
        ...
        cS, cI, xmin, xmax, m, b = self.compute_obstacle_constraints(self.xmeasure)
