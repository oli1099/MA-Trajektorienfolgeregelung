...
class MPCClosedLoop(Node):
    def __init__(self):
        ...
        self.Q = np.diag([0.01,0.01,0.001,1,1,1]) #Höhere Bestrafung auf der Position
        self.R = 0.000001*np.eye(self.nu)
        self.QN = self.Q
        self.Safezone = 0.2

        self.Ts = 0.1 #Diskretisierungszeit
        self.Np = 40 #Prediction Horizon
